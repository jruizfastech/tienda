...
<html lang="es">
  <head>
    ...
    <meta name="author" content="Fastech S.A.S.">
      ...
      <div class="login-box flipped">
        ...
        <form id="formCambiarPass" name="formCambiarPass" class="forget-form" action="">
          ...
          <div class="form-group">
            <input id="txtPassword" name="txtPassword" class="form-control" type="password" placeholder="Nueva Contraseña" require>
          </div>
          <div class="form-group">
            <input id="txtPasswordConfirm" name="txtPasswordConfirm" class="form-control" type="password" placeholder="Confirmar Contraseña" require>
          </div>
